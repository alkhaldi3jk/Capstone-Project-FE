  ...
  return (
    ...
    <View>
      ...
      >
        ...
        mt="0.5"
        px="6"
        color="black">About This Service</Heading>
        <Text 
        font-family= "lucida grande', tahoma, verdana, arial, sans-serif"
        letterSpacing="2"
        px="6"
        
        >Add some color to your home with fresh flowers from your go-to local florist or grocery store. Let us know what you like- or let your Maia make it a surprise, delivered to your door.
          Pricing:  Flowers are curated based on your budget specified here. </Text>
      </Box>
      <Box>
      ...
      >
        ...
        mt="0.5"
        color="black"
        isFullWidth="true">Preferences</Heading>
        <Text>What is your flower budget?
What type, color, and size flowers would you like?
Do you want your flowers from a florist or from the grocery store?
Upload a photo to help us find flowers you like.
</Text>
<Button
